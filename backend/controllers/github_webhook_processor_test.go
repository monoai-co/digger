...
func newGithubWebhookProcessorTestDatabase(t *testing.T) *models.Database {
	...
	require.NoError(t, gormDB.AutoMigrate(&models.ControlPlaneFence{}, &models.GithubWebhookOrderingDomain{}, &models.GithubWebhookDelivery{}, &models.GithubWebhookDeliveryRequeue{}, &models.ControlOperation{}, &models.OutboxEffect{}, &models.GithubReportCreateAttempt{}))
